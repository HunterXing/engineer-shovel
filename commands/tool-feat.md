...
| Mode | Caveman | When |
|------|---------|------|
| `--fast` | `/caveman lite` | Single file, obvious feature |
| `--standard` | `/caveman full` | Multiple files, clear scope (default) |
| `--deep` | `/caveman full` → `ultra` | Cross-module/security/ambiguous |
