...
| `review` | Show full diff for review | `/tool-branch review` |
| `merge` | Squash merge to source, delete branch | `/tool-branch merge` |
...
3. **Review**: `/tool-branch review` — shows diff vs source branch
